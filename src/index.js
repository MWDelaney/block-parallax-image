 ...
 * @see https://developer.wordpress.org/block-editor/developers/block-api/#registering-a-block
 */
registerBlockType( 'rebel/parallax-images', {
	/**
  ...
  attributes: {
    ...
    const { className, attributes } = props;
		...
		return (
			<div data-scale={ attributes.scale } data-delay={ attributes.delay } data-orientation={ attributes.orientation } data-overflow={ attributes.overflow } data-maxtransition={ attributes.maxTransition }>
        <InnerBlocks.Content />
			</div>
		);
	},
